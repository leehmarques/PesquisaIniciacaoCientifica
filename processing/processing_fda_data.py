...
def save_data(df, output_folder, filename):
    """Save the dataframe as a CSV file with the appropriate encoding inside a specific folder."""
...
if __name__ == "__main__":
    ...
    if not df_raw.empty:
        ...
        print("Error: No data was downloaded. Please check your connection or the URL links.")